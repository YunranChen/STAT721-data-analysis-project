...
With the same model, using Bayesian Average Model to estimate the parameter with hyper-g-n prior(mixture prior). To answer the questions, I mainly concentrate on $Pr(\gamma_i=0)$ and the shape of posterior distribution for $\beta_i$ (or confidence interval). 
