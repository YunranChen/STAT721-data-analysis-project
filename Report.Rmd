...
I use MLE/OLS to estimate the parameters. I use F-test and t-test to settle down the problems we care about.
...
2. For overall test for discrete variable (factors), I adopted F-test. And for specific problem, I use t-test.(Sometimes need to construct t-test on my own.)
